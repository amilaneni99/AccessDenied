...
//        myRow4.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
  ...
  //      myRow5.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
    ...
    //    myRow6.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
      ...
      //  myRow7.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
        ...
        //myRow8.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
        ...
        //myRow9.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
        ...
        //myRow10.setImage(BitmapFactory.decodeResource(getResources(),R.drawable.iete));
